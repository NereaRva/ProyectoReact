...
const Header = () => {
    ...
    const {toggleDropdown} = DisneyContext  
    const {isDropdownOpen} = DisneyContext
    const {favoriteCharactersDetails} = DisneyContext
    const {handleRemoveFavorite} = DisneyContext
